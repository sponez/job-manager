...
func TestJobHandlerCreateJob(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := NewJobHandler(service).createJob(ctx, input)
			if calls != 1 {
...
func TestJobHandlerGetJob(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := NewJobHandler(service).getJob(ctx, &dtos.GetJobInput{ID: tt.id})
...
func TestJobHandlerCompleteJob(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := NewJobHandler(service).completeJob(ctx, &dtos.CompleteJobInput{ID: tt.id})
			if calls != tt.wantCalls {
...
func TestJobHandlerGetJobs(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := NewJobHandler(service).getJobs(ctx, &dtos.GetJobsInput{})
			if calls != 1 {
